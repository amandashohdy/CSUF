...
to the other end exhaustively. If the starting location (the top left corner) or the ending location (the 
...
Exhaustive execution of grid size 72 took 0 microseconds